...
models
    ...
    .remove({}, function (err, res) {
        ...
        models
            .Comment
            .create(commentsData, function (err, comments) {
                if (err) {
            ...
            .create([
                {
                    title: 'Title',
                    content: 'Content',
                    thumbnail_image_url: 'http://www.readersdigest.ca/wp-content/uploads/2011/01/4-ways-cheer-up-depressed' +
                            '-cat.jpg',
                    votes: 3,
                    ...
                    thumbnail_image_url: 'https://ichef.bbci.co.uk/news/1024/cpsprodpb/693C/production/_95804962_p0517py6.' +
                            'jpg',
                    votes: 12,
                    comments: []
                }
